//! externalblock extension=lua ObjectMerger $FILENAME$
    ...
    //! i makechange(current, "unsf", "(Agon Child1)")
    //! i makechange(current, "urac", "human")
    //! i makechange(current, "upoi", (upoi + VIL_CONS) .. "")
	//! i unitId = add(unitId, "")
    //! i upoi = upoi + 1
    ...
    //! i makechange(current, "uclg", "125")
    //! i makechange(current, "uclb", "75")
    //! i makechange(current, "unsf", "(Agon Child2)")
    //! i makechange(current, "urac", "human")
    //! i makechange(current, "upoi", (upoi + VIL_CONS) .. "")
	//! i unitId = add(unitId, "")
    //! i upoi = upoi + 1
    ...
    //! i makechange(current, "uclg", "125")
    //! i makechange(current, "uclb", "75")
    //! i makechange(current, "unsf", "(Agon Man1)")
    //! i makechange(current, "urac", "human")
    //! i makechange(current, "upoi", (upoi + VIL_CONS) .. "")
	//! i unitId = add(unitId, "")
    //! i upoi = upoi + 1
    ...
    //! i makechange(current, "uclg", "125")
    //! i makechange(current, "uclb", "75")
    //! i makechange(current, "unsf", "(Agon Man2)")
    //! i makechange(current, "urac", "human")
    //! i makechange(current, "upoi", (upoi + VIL_CONS) .. "")
	//! i unitId = add(unitId, "")
    //! i upoi = upoi + 1
    ...
    //! i makechange(current, "uclg", "125")
    //! i makechange(current, "uclb", "75")
    //! i makechange(current, "unsf", "(Agon Woman)")
    //! i makechange(current, "urac", "human")
    //! i makechange(current, "upoi", (upoi + VIL_CONS) .. "")
	//! i unitId = add(unitId, "")
    //! i upoi = upoi + 1

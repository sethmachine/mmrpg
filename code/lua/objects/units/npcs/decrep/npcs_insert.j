//! externalblock extension=lua ObjectMerger $FILENAME$
    ...
    //! i makechange(current, "unam", "Prince of Agon")
    //! i makechange(current, "properNames", "Abu Dhabi")
    //! i makechange(current, "umdl", "units\\human\\Arthas\\Arthas")
    ...
    //! i makechange(current, "umdl", "Leprekon.mdx")
    //! i makechange(current, "uclr", "255")
    //! i makechange(current, "uclg", "255")
    //! i makechange(current, "uclb", "255")
    //! i makechange(current, "unam", "Alfonso")
	...
	//! i heroId = add(heroId, "")
    //! i createobject(dummyHeroId, heroId)
    //! i makechange(current, "unam", "Bandit Lord")
    //! i makechange(current, "properNames", "Jaffar")
    //! i makechange(current, "umdl", "units\\creeps\\BanditLord\\BanditLord")
	...
	//! i vendorId = add(vendorId, "")
    //! i createobject(dummyVendorId, vendorId)
    //! i makechange(current, "uico", "ReplaceableTextures\\CommandButtons\\BTNBandit.blp")
    //! i makechange(current, "umdl", "units\\creeps\\Bandit\\Bandit")
    //! i makechange(current, "uclr", "255")
    //! i makechange(current, "uclg", "255")
    //! i makechange(current, "uclb", "255")
    //! i makechange(current, "utco", "\12")
    //! i makechange(current, "unam", "Famished Bandit")
    //! i makechange(current, "upoi", (upoi + NPC_CONS) .. "")
    //! i upoi = upoi + 1
    //***************
    // Isaiah
	...
	//! i vendorId = add(vendorId, "")
    //! i createobject(dummyVendorId, vendorId)
    //! i makechange(current, "unam", "Sage Athos")
    //! i makechange(current, "uico", "ReplaceableTextures\\CommandButtons\\BTNPriest.blp")
    //! i makechange(current, "umdl", "units\\human\\Priest\\Priest")
    //! i makechange(current, "uclr", "255")
    //! i makechange(current, "uclg", "125")
    //! i makechange(current, "uclb", "75")
	//makes team color yellow
    //! i makechange(current, "utco", "\4")
